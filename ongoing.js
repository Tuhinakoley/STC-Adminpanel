...
function showOrderList(){
		...
		$.ajax({
				url: serverURL + 'get_inprogress_job_by_admin',
				dataType: 'json',
				type: 'get',
						...
						$.map(data.order_details,function(item){
							...
							*/
							...
							if(item.order_status_id == 2){
								...
								editButton = '<button type="button" style="margin-bottom: 8px;" class="btn btn-info" data-tooltip="Upload Preview" title="Upload Preview" id="changeActionStatusBtn'+i+'" onclick="updateuploadpreview('+item.id+');">Upload Preview</button>'+viewapprove+'<button type="button" style="margin-bottom: 8px;" class="btn btn-default" data-tooltip="Sent Printing" title="Sent Printing" onclick="" id="changeActionStatusBtn'+i+'" disabled>Sent Printing</button><button type="button" class="btn btn-default" data-tooltip="Packed & Dispatched" title="Packed & Dispatched" onclick="" id="changeActionStatusBtn'+i+'"  disabled>Packed & Dispatched</button>';
								...
								editButton = '<button type="button" style="margin-bottom: 8px;" class="btn btn-info" data-tooltip="Upload Preview" title="Upload Preview" disabled id="changeActionStatusBtn'+i+'">Upload Preview</button>'+viewapprove_viewremarks+'<button type="button" style="margin-bottom: 8px;" class="btn btn-info" data-tooltip="Sent Printing" title="Sent Printing" onclick="" id="changeActionStatusBtn'+i+'"  disabled>Sent Printing</button><button type="button" class="btn btn-info" data-tooltip="Packed & Dispatched" title="Packed & Dispatched" onclick="updatepackeddispatch('+item.id+');" id="changeActionStatusBtn'+i+'">Packed & Dispatched</button>';
							}else if(item.order_status_id == 7){
								
								editButton = '<button type="button" style="margin-bottom: 8px;" class="btn btn-info" data-tooltip="Upload Preview" title="Upload Preview" onclick="" disabled id="changeActionStatusBtn'+i+'">Upload Preview</button>'+viewapprove_viewremarks+'<button type="button" style="margin-bottom: 8px;" class="btn btn-info" data-tooltip="Sent Printing" title="Sent Printing" onclick="" id="changeActionStatusBtn'+i+'"  disabled>Sent Printing</button><button type="button" class="btn btn-info" data-tooltip="Packed & Dispatched" title="Packed & Dispatched" onclick="" id="changeActionStatusBtn'+i+'" disabled>Packed & Dispatched</button>';
							}
...
function showOrderListDistributer(){
		...
		$.ajax({
				url: serverURL + 'get_inprogress_job_distributer',
				dataType: 'json',
				type: 'post',
				data:{
					user_id: user_details.id
